...
$(function() {
		...
		OrderView = Backbone.View.extend({
			...
			initialize: function() {
				...
				//Backbone.Mediator.sub("tm_order_new", this.newRender, this);
				//Backbone.Mediator.sub("tm_order_show", this.existShow, this);
				
				Backbone.Mediator.sub("tm_order_show_upgrade", this.universalShow, this);				
			},
